...
public final class GuiMusicBox extends GuiBase {
  ...
  // gui text
  private static final TranslatableComponent next_text         = new TranslatableComponent("gui.addsynthcore.music_box.next");
  private static final TranslatableComponent tempo_text        = new TranslatableComponent("gui.addsynthcore.music_box.tempo");
  private static final TranslatableComponent ticks_text        = new TranslatableComponent("gui.addsynthcore.music_box.ticks");
  private static final TranslatableComponent bpm_text          = new TranslatableComponent("gui.addsynthcore.music_box.bpm");
  private static final TranslatableComponent current_note_text = new TranslatableComponent("gui.addsynthcore.music_box.current_note");
  private static final TranslatableComponent instrument_text   = new TranslatableComponent("gui.addsynthcore.music_box.instrument");
  private static final TranslatableComponent[] instrument = new TranslatableComponent[] {
    new TranslatableComponent("gui.addsynthcore.instrument.harp"),
    new TranslatableComponent("gui.addsynthcore.instrument.bass"),
    new TranslatableComponent("gui.addsynthcore.instrument.bass_drum"),
    new TranslatableComponent("gui.addsynthcore.instrument.snare_drum"),
    new TranslatableComponent("gui.addsynthcore.instrument.click"),
    new TranslatableComponent("gui.addsynthcore.instrument.bell"),
    new TranslatableComponent("gui.addsynthcore.instrument.chime"),
    new TranslatableComponent("gui.addsynthcore.instrument.flute"),
    new TranslatableComponent("gui.addsynthcore.instrument.guitar"),
    new TranslatableComponent("gui.addsynthcore.instrument.xylophone"),
    new TranslatableComponent("gui.addsynthcore.instrument.iron_xylophone"),
    new TranslatableComponent("gui.addsynthcore.instrument.cow_bell"),
    new TranslatableComponent("gui.addsynthcore.instrument.didgeridoo"),
    new TranslatableComponent("gui.addsynthcore.instrument.square"),
    new TranslatableComponent("gui.addsynthcore.instrument.banjo"),
    new TranslatableComponent("gui.addsynthcore.instrument.pling")
  };
