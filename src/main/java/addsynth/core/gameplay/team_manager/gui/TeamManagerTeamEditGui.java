...
public final class TeamManagerTeamEditGui extends GuiBase {
  ...
  private static final TranslatableComponent                 team_gui = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.gui_title");
  private static final TranslatableComponent        team_id_name_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.id_name");
  private static final TranslatableComponent   team_display_name_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.display_name");
  private static final TranslatableComponent       friendly_fire_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.friendly_fire");
  private static final TranslatableComponent see_invisible_allys_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.see_invisible_allys");
  private static final TranslatableComponent          team_color_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.team_color");
  private static final TranslatableComponent show_nametag_option_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.show_nametag");
  private static final TranslatableComponent show_death_messages_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.show_death_messages");
  private static final TranslatableComponent       member_prefix_text = new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.member_prefix");
  ...
  private static final Component[] team_options = {
    new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.always"),
    new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.never"),
    new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.this_team_only"),
    new TranslatableComponent("gui.addsynthcore.team_manager.team_edit.other_teams_only")
  };
  ...
  protected final void init(){
    ...
    team_id_name           = new EditBox(this.font,  left_x, widget_line_1, left_text_box_width, text_box_height, TextComponent.EMPTY);
    team_display_name      = new EditBox(this.font, right_x, widget_line_1, right_text_box_width, text_box_height, TextComponent.EMPTY);
    ...
    member_prefix          = new EditBox(this.font,  left_x, widget_line_4, left_text_box_width, text_box_height, TextComponent.EMPTY);
    member_suffix          = new EditBox(this.font, right_x, widget_line_4, right_text_box_width, text_box_height, TextComponent.EMPTY);
